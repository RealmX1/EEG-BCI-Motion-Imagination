...
| Schirrmeister2017 | 3,310 | 128 | 14/14 | — | 完整 ✓ |
| Shin2017A | 1,513 | 30 | 29/29 | 5.0% | 完整 |
| Stieger2021 | 61,526 | 60 | 62/62 | — | 完整 ✓ |
| **总计** | **~78,000+** | — | — | — | — |

### 3.2 数据完整性 (2026-03-23 更新)

**Schirrmeister2017**: 已补全至 **14/14 被试** (2026-03-22)，LMDB 预处理后 3,310 segments (过滤后)，15 GB。

**Stieger2021**: 已补全至 **62/62 被试** (2026-03-23)，LMDB 预处理后 61,526 segments，120 GB。

> **注意**: 数据采样权重仍不均衡——Stieger2021 在补全后占比更高 (~79%)，V2 训练已使用 78,232 segments (含完整 Stieger2021)。
...
Stieger2021 占采样权重 78.6%（V2 中 61,526/78,232 segments），虽已补全至 62/62 被试，但训练仍严重偏向该数据集的分布。
...
1. ~~**补全数据**~~: Schirrmeister2017 和 Stieger2021 **已补全** (2026-03-23)。V2 训练已使用补全后的 Stieger2021 数据 (61,526 segments)，结果仍为负迁移
