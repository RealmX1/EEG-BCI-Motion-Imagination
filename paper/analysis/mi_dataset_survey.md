...
### 5.1 已补全的数据集 (2026-03-23 更新)

| 数据集 | 状态 | 被试数 | 备注 |
|--------|:---:|:---:|----------|
| Schirrmeister2017 | **已补全** ✓ | 14/14 | 全部 14 被试已下载并预处理 (LMDB 15 GB) |
| Stieger2021 | **已补全** ✓ | 62/62 | 全部 62 被试已下载并预处理 (LMDB 120 GB) |
...
|--------|:---:|------|
| Weibo2014 | 10 | `FileNotFoundError: MNE-weibo-2014/data0.zip.unzip` — zip 解压路径问题 |
| Dreyer2023 | 87 | `HTTPError: 404` — OSF 下载链接失效 |

### 5.3 LMDB 预处理总量

补全后 10 个数据集 LMDB 总量约 **173 GB**，Stieger2021 独占 120 GB (69%)。
